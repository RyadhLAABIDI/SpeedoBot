...
class MedicalScreen extends StatefulWidget {
  ...
  @override
  _MedicalScreen createState() => _MedicalScreen();
}
...
Future<void> _sendMessage() async {
  ...
  if (message.isNotEmpty) {
    ...
    await _getMedicalResponse(message);
  }
}

// Fonction pour envoyer la requête à l'API et obtenir la réponse
Future<void> _getMedicalResponse(String question) async {
  final url = Uri.parse('https://chat.speedobot.com/medical');
...
Widget _buildMessage(String message, int index) {
  ...
  return TextField(
    ...
    decoration: InputDecoration(
      hintText: 'compose_medical_question'.tr,
       hintStyle: TextStyle(
